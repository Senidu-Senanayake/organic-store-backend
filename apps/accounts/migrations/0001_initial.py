    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('admin', 'Admin'), ('moderator', 'Moderator'), ('warehouse_manager', 'Warehouse Manager')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(choices=[('facebook', 'Facebook'), ('google', 'Google'), ('twitter', 'Twitter'), ('instagram', 'Instagram')], max_length=20)),
